...
<nav id="myModal" class="navbar fixed-top navbar-expand-lg navbar-light bg-light py-3 py-lg-5">
	<div class="container">
    <div>
   <a href="#"> <img src="img/logo3.png" alt="" style="width: 170px;"></div></a>
...
<div class="my-3" >
 ...
 <h1 style="text-align: left; font-size:26px;"><b>Compare and book flights with ease</b></h1> <p style="text-align: left;font-size:19px">A niche travel agency for flights only</p>
...
<p>Round-trip</p> 
 <form name="google-sheet"  method="post" autocomplete="off" style="background-color: rgb(214, 223, 231);" class="form-control">
       ...
       <div class="row">
         ...
         <div class="col-md-3">
         <div class="g-recaptcha rec1" style="margin-top:13px; transform:scale(0.67);-webkit-transform:scale(0.67);transform-origin:0 0;-webkit-transform-origin:0 0;" data-sitekey="6Lced84eAAAAAJ4tKPnPVu_WnDajpKn-PZdTUaK8"></div></div>
    </div>
    <div class="row">
         <div class="col-md-2">
...
<form name="google-sheet3"  method="post" autocomplete="off" style="background-color: rgb(214, 223, 231);" class="form-control">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
      <div class="g-recaptcha" style="margin-top:13px; transform:scale(0.67);-webkit-transform:scale(0.67);transform-origin:0 0;-webkit-transform-origin:0 0;" data-sitekey="6Lced84eAAAAAJ4tKPnPVu_WnDajpKn-PZdTUaK8"></div></div>
      <div class="row">
      <div class="col-md-3">
...
<section class="gallery-block cards-gallery" id="portfolio">
       ...
       <h3 style="text-align: left; font-size:20px;" class="font-weight-bold">Popular Destinations</h3> <p style="text-align: left;">Get the best deals on international flights</p>
       <div class="btn-group" role="group" aria-label="Basic example">
...
<div class="controls-top">
  ...
  <a class="btn-floating" href="#multi-item-example" data-slide="next" style="float: right"><i
...
<div class="carousel-inner" role="listbox">
  ...
  <div class="carousel-item active">
    ...
    <div class="col-md-3" style="float:left">
     <div class="card mb-2">
     <a   target="_blank" href="https://www.london.gov.uk/">   <img class="card-img-top"
          src="https://source.unsplash.com/1400x1200/?london"alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-3" style="float:left">
      <div class="card mb-2">
     <a  target="_blank" href="https://www.orlando.gov/Home">  <img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?orlando" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-3" style="float:left">
      <div class="card mb-2">
      <a   target="_blank" href="https://www.denvergov.org/Home"> <img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?denver" alt="Card image cap">
        <div class="card-body">
     ...
     <div class="col-md-3" style="float:left">
     <div class="card mb-2">
    <a  target="_blank" href="https://www.miamigov.com/Home">    <img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?miami" alt="Card image cap">
        <div class="card-body">
  ...
  <div class="carousel-item">
    ...
    <div class="col-md-3" style="float:left">
      <div class="card mb-2">
      <a  target="_blank" href="https://en.parisinfo.com/"> <img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?paris" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-3" style="float:left">
      <div class="card mb-2">
       <a  target="_blank" href="https://www.rome.net/"> <img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?rome" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-3" style="float:left">
      <div class="card mb-2">
     <a  target="_blank" href="https://www.santafenm.gov/">  <img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?mexico" alt="Card image cap">
        <div class="card-body">
    ...
    <div class="col-md-3" style="float:left">
      <div class="card mb-2">
    <a  target="_blank" href="https://www.charleston-sc.gov/"><img class="card-img-top"
        src="https://source.unsplash.com/1400x1200/?charleston" alt="Card image cap">
        <div class="card-body">
...
<br>
                  ...
                  <div class="text-center">
                    <button class="btn btn-primary" type="submit"  name="msg" style="font-family: 'Heebo';">Send<i
          ...
          <div class="col-md-3 text-center">
            ...
            <a href="">     <i class="fas fa-map-marker-alt" style="font-size: 30px;"></i></a> 
                ...
                <a href=""> <li><i class="fa fa-phone mt-4 fa-2x"></i> <br> </a> 
                    <a style="color:rgb(0, 0, 0);"  href="tel:+1 424-234-1650">(424) 234-1650</a>
                  </li>
  
                 <a href=""><li><i class="fa fa-envelope mt-4 fa-2x"></i> <br></a> 
        ...
        <br>    · To better understand your needs and provide you with the services you have requested; 
         ...
         <br>The right of data portability: this means you can obtain and use the data we hold for your own 
           ...
           <b> How to Contact Us </b> <br>
            ...
            BOOKING DBA. 460 N Beverly Dr. Beverly Hills, California 90210</p>
        </div>
...
form3.addEventListener('submit', e => {
  e.preventDefault()
  prg()
    fetch("oneway.php", { method: 'POST', body: new FormData(form3)})
...
form2.addEventListener('submit', e => {
  e.preventDefault()
  prg()
  fetch("multicity.php", { method: 'POST', body: new FormData(form2)})
...
function sheet3(){
  ...
  form.addEventListener('submit', e => {
    e.preventDefault();
   prg()
    fetch("round_trip.php", { method: 'POST', body: new FormData(form)})
...
function sheet1(){
  ...
  form4.addEventListener('submit', e => {
    e.preventDefault()
    prg()
    fetch("register.php", { method: 'POST', body: new FormData(form4)})
